...
def get_azure_supported_voices():
    return [
        ...
        "yue-CN-YunSongNeural", "zh-CN-Xiaochen:DragonHDLatestNeural", "zh-CN-XiaochenMultilingualNeural",
        ...
        "zh-CN-XiaoxiaoDialectsNeural", "zh-CN-XiaoxiaoMultilingualNeural", "zh-CN-XiaoxiaoNeural",
        ...
        "zh-CN-YunxiaNeural", "zh-CN-YunxiaoMultilingualNeural", "zh-CN-YunyangNeural", "zh-CN-YunyeNeural",
        "zh-CN-YunyiMultilingualNeural", "zh-CN-YunzeNeural", "zh-CN-guangxi-YunqiNeural", "zh-CN-henan-YundengNeural",
